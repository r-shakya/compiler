...
%token NUM ID START END INTEGER CHAR FLOAT IF ELSE WHILE
...
statements: assignexpr ';'    {}
    | statements assignexpr ';' {}
    | statements IF logicalexpr '{' statements '}' { printf("if statement only \n"); }
    | statements IF logicalexpr '{' statements '}' ELSE '{' statements '}' { printf("if-else statement \n"); }
    | statements WHILE logicalexpr '{' statements '}' { printf("while statement \n"); }
    ;
